library(readr)
Walmart <- read.csv("E:/Day Wise/Day 38 Forecasting Contd/Data/Walmart Footfalls Raw.csv") # read the Walmart data
...
####################### Predicting new data #############################
library(xlsx)
test_data <- read.csv("E:/Day Wise/Day 38 Forecasting Contd/Data/Predict_new.csv")
View(test_data)
